...
chability () {
    ...
    sed -ie 's/ABILITY_MIN_BOUND.*/ABILITY_MIN_BOUND = $1;/g' configurations/SimulationConfigurations.java
    sed -ie 's/ABILITY_MAX_BOUND.*/ABILITY_MAX_BOUND = $1;/g' configurations/SimulationConfigurations.java
...
chmoney () {
    ...
    sed -ie 's/MONEY_MIN_BOUND.*/MONEY_MIN_BOUND = $1;/g' configurations/SimulationConfigurations.java
    sed -ie 's/MONEY_MAX_BOUND.*/MONEY_MAX_BOUND = $1;/g' configurations/SimulationConfigurations.java
...
chdistance () {
    ...
    sed -ie 's/TRACK_DISTANCE_MIN_BOUND.*/TRACK_DISTANCE_MIN_BOUND = $1;/g' configurations/SimulationConfigurations.java
    sed -ie 's/TRACK_DISTANCE_MAX_BOUND.*/TRACK_DISTANCE_MAX_BOUND = $1;/g' configurations/SimulationConfigurations.java
