 ...
 * @version 2.0
 */
public enum HorseJockeyState implements Serializable {
    /**
     ...
     */
    AT_THE_START_LINE("AT_THE_START_LINE"),
    /**
     ...
     */
    AT_THE_FINNISH_LINE("AT_THE_FINISH_LINE");

    HorseJockeyState(String state) {
        this.state = state;
    }
