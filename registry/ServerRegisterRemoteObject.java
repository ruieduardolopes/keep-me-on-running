...
public class ServerRegisterRemoteObject {
    public static void main(String[] args) {
        ...
        Logger.printNotification("Trying to run RMI Registry Server on %s with port %s", args[0], args[1]);
        ...
        int listeningPort = RMI_LISTENING_PORT;
        try {
    ...
    private static final int RMI_LISTENING_PORT = 0; // TODO : change port
}
